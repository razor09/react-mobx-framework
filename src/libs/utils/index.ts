import { ClassName, ClassNameCollection, Optional, PlainArray, PlainObject, PlainValue, Primitive, StringOrBoolean, StringOrNumber } from './typings'
...
export namespace Utils {
  ...
  export const debounce = (delay?: number): Function => {
    return (method?: Function): Optional<Function> => {
      if (method) {
        let timeout: NodeJS.Timeout
        return function (this: never, ...params: never[]): void {
